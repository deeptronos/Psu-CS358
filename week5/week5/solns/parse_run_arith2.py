...
from interp_arith2 import Add, Sub, Mul, Div, Neg, Let, Name, Lit, Exp, Expr, run

from lark import Lark, Token, ParseTree, Transformer
from lark.exceptions import VisitError
from pathlib import Path

parser = Lark(Path('expr2.lark').read_text(),start='expr',ambiguity='explicit')
...
class ToExpr(Transformer[Token,Expr]):
    ...
    def exp(self, args:tuple[Expr, Expr]) -> Expr:
