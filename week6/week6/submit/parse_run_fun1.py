from interp_fun1 import Add, Sub, Mul, Div, Neg, Let, Name, Lit, Ifnz, Letfun, App, Expr, run
...
class ToExpr(Transformer[Token,Expr]):
    ...
    def letfun(self, name: Token, params: List[Token], body: Expr, result: Expr) -> Letfun:
            return Letfun(name.value, [param.value for param in params], body, result)
